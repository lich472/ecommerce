...
// TODO: based on creating featured Product and their UI -> improve the product items by adding "product description" when user click on specific product and sliding many picture of that items for references ==> 
// reference youtube: https://youtu.be/sX57TLIPNx8 and go to "Featured Product Slider" part of video
